...
public class Tree {
    ...
    public boolean isNamePyramid() {
        if(this.getLeft() != null){
            if (this.getLeft().getName().length() < this.getName().length()){
                return false;
            }
            if (!this.getLeft().isNamePyramid()){
                return false;
            }
        }
        if (this.getRight() != null) {
            if (this.getRight().getName().length() < this.getName().length()) {
                return false;
            }
            if (!this.getRight().isNamePyramid()) {
                return false;
            }
        }
        return true;
